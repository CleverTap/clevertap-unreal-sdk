...
void USampleMainMenu::ConfigureSharedInstance()
{
	...
	// We're now ready to handle the OnPushNotificationClicked notifications, to enable them.
	// If we were launched in response to clicking on a notification, this
	// will generate a broadcast of OnPushNotificationClicked
	...
	// this will generate a broadcast of OnOpenUrl
	...
	// Any previously queued notifications or notifications generated by app launch will be displayed after this call
